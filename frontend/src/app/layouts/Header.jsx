...
import { CheckCircle2, Clock, LogOut, Menu, RefreshCw, Store, User as UserIcon, XCircle } from 'lucide-react';
  ...
  return (
    <header className="h-16 border-b border-slate-800 bg-slate-900/80 backdrop-blur-xl px-4 md:px-6 flex items-center justify-between sticky top-0 z-30">
      <div className="flex items-center gap-3">
        <button onClick={onToggleSidebar} className="p-2 rounded-xl text-slate-400 hover:text-slate-100 hover:bg-slate-800 transition-colors md:hidden">
      ...
      <div className="flex items-center gap-3">
        ...
        <div className="flex items-center gap-3 pl-2 border-r border-slate-800 mr-2 pr-2">
          ...
          <Button variant="ghost" size="sm" onClick={logout} title="تسجيل الخروج" className="text-slate-400 hover:text-rose-400 hover:bg-rose-500/10 p-2 rounded-xl">
