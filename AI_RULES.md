...
5. Keep the target stack simple: React, JavaScript, Vite, Tailwind CSS, Axios, Laravel, PHP, MySQL, Sanctum, and REST.
6. Do not introduce TypeScript, TanStack Query, Redux, Zustand, SQLite, Redis, Docker, GraphQL, or unnecessary dependencies.
7. Use MySQL for application runtime. Testing strategy changes must be explicitly planned and verified.
