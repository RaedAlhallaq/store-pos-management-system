    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4" dir="rtl">
      ...
      <div className="relative bg-white rounded-2xl shadow-2xl w-full max-w-md max-h-[90vh] flex flex-col" style={{ fontFamily: 'monospace' }}>
        ...
        <div className="overflow-y-auto flex-1 p-6 text-gray-900 text-sm leading-relaxed">
          ...
          <div className="space-y-1 border-b border-dashed border-gray-300 pb-3 mb-3">
            <p className="font-bold text-center text-xs text-gray-500">ملخص المبيعات</p>
            ...
            <div className="flex justify-between text-gray-600"><span>نقداً:</span><span>{fmt(zReport.total_sales_cash)} ₪</span></div>
            <div className="flex justify-between text-gray-600"><span>بطاقة:</span><span>{fmt(zReport.total_sales_card)} ₪</span></div>
            <div className="flex justify-between text-gray-600"><span>آجل:</span><span>{fmt(zReport.total_sales_credit)} ₪</span></div>
          </div>
          <div className="space-y-1 border-b-2 border-dashed border-gray-400 pb-3 mb-3">
            <p className="font-bold text-center text-xs text-gray-500">نتيجة الجرد</p>
          ...
          <div className="text-center text-xs text-gray-500 mt-3"><p>نهاية التقرير</p></div>
        </div>
      </div>
    </div>
  );
